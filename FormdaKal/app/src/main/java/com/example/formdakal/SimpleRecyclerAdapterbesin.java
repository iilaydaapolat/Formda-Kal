...
public class SimpleRecyclerAdapterbesin extends RecyclerView.Adapter<SimpleRecyclerAdapterbesin.ViewHolder> {
    ...
    public SimpleRecyclerAdapterbesin(List<Person> list_person, CustomItemClickListener listener) {
    ...
    @Override
    public SimpleRecyclerAdapterbesin.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_viewbesin_layout, parent, false);
